 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_musictheory_harmonic_dictation_renderer extends qtype_musictheory_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa, question_display_options $options) {
        ...
        if (!$options->readonly) {
            $result .= $OUTPUT->help_icon('harmonic_dictation_questionastext', 'qtype_musictheory', '');
        }
        ...
        if (!$options->readonly) {
            $result .= $OUTPUT->help_icon('harmonic_dictation_questionasui', 'qtype_musictheory', '');
        }
        $result .= html_writer::end_tag('div');
